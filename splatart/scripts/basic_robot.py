...
def demo(fix_root_link, balance_passive_force):
    ...
    robot: sapien.Articulation = loader.load("/home/stanlew/src/urdf_files_dataset/urdf_files/random/robot-assets/fetch/robots/fetch.urdf")
    robot.set_root_pose(sapien.Pose([0, 0, 0], [1, 0, 0, 0]))

    # Set initial joint positions
    # get the initial qpos from the robot
